...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectDestructuringEmpty2 = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10)(IteratorPrototype, __webpack_require__(92)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Season = __webpack_require__(116);

	var _Season2 = _interopRequireDefault(_Season);

	var _Trailer = __webpack_require__(126);
	...
	exports.default = {
	  ...
	  components: {
	    Season: _Season2.default, Trailer: _Trailer2.default, VideoPlayer: _VideoPlayer2.default
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v(_vm._s(episode.name))]), _vm._v(" "), (episode.src) ? _c('i', {
	      staticClass: "item-has-src"
	    }) : _vm._e(), _vm._v(" "), (episode.release_episode_human_format) ? _c('span', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "C:\\Users\\pyxl\\Code\\flox\\client\\app\\components\\Modal\\VideoPlayer.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-f9b5df1e", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-f9b5df1e", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] VideoPlayer.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: (0, _extends3.default)({}, (0, _vuex.mapMutations)(['CLOSE_MODAL']), {
	    fetchEpisode: function fetchEpisode() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "modal-header"
	  }, [(_vm.modalData.mediaType == 'tv') ? _c('span', [_c('input', {
	    directives: [{
	      name: "model",
	      rawName: "v-model",
	      value: (_vm.episodeId),
	      expression: "episodeId"
	    }],
	    attrs: {
	      "type": "text",
	      "placeholder": "ID der Episode"
	    },
	    domProps: {
	      "value": _vm._s(_vm.episodeId)
	    },
	    on: {
	      "input": function($event) {
	        if ($event.target.composing) { return; }
	        _vm.episodeId = $event.target.value
	      }
	    }
	  }), _vm._v(" "), _c('button', {
	    on: {
	  ...
	  }, [_vm._v("Fetch")])]) : _vm._e(), _vm._v(" "), _c('span', {
	    staticClass: "close-modal",
	    on: {
	      "click": function($event) {
	        _vm.CLOSE_MODAL()
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-f9b5df1e", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [(_vm.modalType == 'season') ? _c('season') : _vm._e(), _vm._v(" "), (_vm.modalType == 'trailer') ? _c('trailer') : _vm._e(), _vm._v(" "), (_vm.modalType == 'video-player') ? _c('video-player') : _vm._e()], 1), _vm._v(" "), (_vm.overlay) ? _c('span', {
	    staticClass: "overlay",
	    on: {
	      "click": function($event) {
	        _vm.CLOSE_MODAL()
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchContent = __webpack_require__(147);
	...
	var _TMDBContent = __webpack_require__(181);

	var _TMDBContent2 = _interopRequireDefault(_TMDBContent);

	var _Subpage = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(['loadItems', 'loadMoreItems', 'setSearchTitle', 'setPageTitle']), {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rating = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Backup = __webpack_require__(174);

	var _Backup2 = _interopRequireDefault(_Backup);

	var _Misc = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: (0, _extends3.default)({}, (0, _vuex.mapMutations)(['SET_LOADING', 'SET_ITEM_LOADED_SUBPAGE', 'OPEN_MODAL', 'CLOSE_MODAL']), (0, _vuex.mapActions)(['setPageTitle']), {
	    ...
	    openVideoPlayer: function openVideoPlayer() {
	      this.OPEN_MODAL({
	        type: 'video-player',
	        data: {
	    ...
	    fetchData: function fetchData() {
	      ...
	      (0, _axios2.default)(config.api + '/item/' + tmdbId + '/' + this.mediaType).then(function (response) {
	        ...
	        _this2.item.tmdb_rating = _this2.intToFloat(response.data.tmdb_rating);

	        _this2.setPageTitle(_this2.item.title);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('main', [_c('section', {
	    ...
	    staticClass: "subpage-poster-wrap-mobile"
	  }, [_c('rating', {
	    attrs: {
	      "item": _vm.item,
	      "set-item": _vm.setItem
	  ...
	  }, [(_vm.item.tmdb_rating && _vm.item.tmdb_rating != 0) ? _c('i', [_c('b', [_vm._v(_vm._s(_vm.item.tmdb_rating))]), _vm._v(" TMDb")]) : _c('i', [_vm._v("No TMDb Rating")])]), _vm._v(" "), (_vm.item.imdb_id) ? _c('a', {
	  ...
	  }, [_c('h2', [_vm._v("Overview")]), _vm._v(" "), _c('p', [_vm._v(_vm._s(_vm.overview))])]), _vm._v(" "), _c('div', {
	  ...
	  })], 1), _vm._v(" "), (_vm.item.rating != null && _vm.auth) ? _c('div', {
	    staticClass: "subpage-sidebar-buttons no-select"
	  }, [_c('span', {
	    staticClass: "button-video-player",
	    on: {
	      "click": function($event) {
	        _vm.openVideoPlayer()
	      }
	    }
	  }, [_vm._v("Watch Video")]), _vm._v(" "), _c('span', {
	    staticClass: "edit-data"
	  }, [_vm._v("Edit data")]), _vm._v(" "), _c('span', {
	  ...
	  }, [_vm._v(_vm._s(_vm.lang('delete movie')))])]) : _vm._e()])])]), _vm._v(" "), _c('span', {
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.loading),
