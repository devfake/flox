...
class FakeApiTest extends TestCase implements ApiTestInterface
{
  ...
  public function setUp(): void
  {
    ...
    $this->apiTest->setApiClass(FakeApi::class);
  ...
  {
    $this->apiTest->it_should_rate_a_movie('fake/movie_rating.json');
  }

  /** @test */
  public function it_should_rate_a_tv_show()
  {
    $this->apiTest->it_should_rate_a_tv_show('fake/tv_rating.json');
  }
